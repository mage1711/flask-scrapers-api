...
def scrap_cards(url = CARDS_URL_START):
    games_info = []
    ...
    games_info = list({each['name']: each for each in games_info}.values())[:ITEMS_PER_PAGE]
...
def write_json(games_list):
    with open(JSON_FOLDER+'output.json', 'w+') as handle:
...
if __name__ == "__main__":
    scrap_cards("https://www.metacritic.com/browse/games/score/metascore/year/all/filtered?view=detailed")
